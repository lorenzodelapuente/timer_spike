...
#Harvest access token: 2695702.pt.6vvt55AAO7KoZV2PnqW-KY6HzgJW2PEhm1esfU5AqurUxLAxgDwz_xdO06zGw3LqTZMiieIcLZSA29MuIjg4NQ
#Harvest Account id: "1461373"
  ...
  def create
    ...
    respond_to do |format|
      if @http_connection.save
        ...
        sql_data["clockify_data"] =  @http_connection["clockify_payload"]
        sql_data["harvest_data"] =  @http_connection["harvest_payload"]    
        sql_data.save
